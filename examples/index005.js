	...
	page.onLoadFinished = function(status) {
		if (status !== 'success') {
			...
			waitFor(function() {
				...
				page.evaluate(function() {
					// http://devel-001.fe-ver.com/domxss/index005.html?
					var user_input = "<img src='' onerror='alert(0);'/>";
                                        var source_taintedno = 9999;
                                        user_input.tainted(source_taintedno);
                                        var input_text = $("#t");
                                        if (input_text)
                                                input_text.val(user_input);
					$('#demo').submit();
				});
